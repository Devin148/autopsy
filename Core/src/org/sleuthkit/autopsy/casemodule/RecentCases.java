...
public final class RecentCases extends CallableSystemAction implements Presenter.Menu {
    ...
    private static Logger logger = Logger.getLogger(RecentCases.class.getName());
    ...
    static public RecentCases getInstance() {
        try {
            INSTANCE.storeRecentCases();
        } catch (IOException ex) {
            logger.log(Level.WARNING, "Unable to refresh list of cases.");
        }
        return INSTANCE;
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            logger.log(Level.WARNING, "Error: Could not clear the properties file.", ex);
        }
    }
    ...
    public void addRecentCase(String name, String unsafePath) {
        ...
        try {
            ...
            logger.log(Level.WARNING, "Error: Could not update the properties file.", ex);
        }
    }
